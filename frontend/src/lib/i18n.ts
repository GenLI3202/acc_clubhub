...
export const ui = {
    zh: {
        ...
        'event.privacyAccept': '我同意隐私政策',
        'event.subscribe': '订阅 ACC 活动通知',
        'event.submitBtn': '提交报名',
        'event.success': '报名成功！确认邮件已发送',
    ...
    en: {
        ...
        'event.privacyAccept': 'I accept the privacy policy',
        'event.subscribe': 'Subscribe to ACC event notifications',
        'event.submitBtn': 'Submit Registration',
        'event.success': 'Registration successful! Confirmation email sent',
    ...
    de: {
        ...
        'event.privacyAccept': 'Ich akzeptiere die Datenschutzerklärung',
        'event.subscribe': 'ACC-Veranstaltungsbenachrichtigungen abonnieren',
        'event.submitBtn': 'Anmeldung absenden',
        'event.success': 'Anmeldung erfolgreich! Bestätigungs-E-Mail gesendet',
