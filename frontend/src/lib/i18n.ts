...
export const ui = {
    zh: {
        ...
        'partners.lede1': '一支俱乐部的脾气，藏在它选择同行的伙伴里。',
        'partners.lede2': '感谢以下品牌与我们一起把每一次骑行做得更好。',
    ...
    en: {
        ...
        'partners.title': 'Across, together.',
        'partners.lede1': "A club's character shows in the company it keeps.",
        'partners.lede2': 'Thanks to the brands who make every ride better.',
        'partners.officialPartners': 'Official Partners',
        'partners.friends': 'Friends of ACC',
    ...
    de: {
        ...
        'partners.title': 'Across, together.',
        'partners.lede1': 'Den Charakter eines Klubs erkennt man an seinen Partnern.',
        'partners.lede2': 'Danke an die Marken, die jede Tour besser machen.',
        'partners.officialPartners': 'Official Partners',
        'partners.friends': 'Friends of ACC',
        'partners.since': 'seit',
