...
export const ui = {
    zh: {
        ...
        'partners.becomePartner.blurb': 'ACC 现有 142 名活跃成员，每年 70+ 次团骑，每月集体完成 1,200+ 公里。我们是慕尼黑认真骑车的那群人——如果你的品牌想找到这批人，欢迎聊聊。',
    ...
    en: {
        ...
        'partners.becomePartner.blurb': 'ACC has 142 active members, 70+ group rides a year, and 1,200+ collective kilometres a month. We\'re the road cyclists who actually show up — if your brand wants to reach this crowd, let\'s talk.',
    ...
    de: {
        ...
        'partners.becomePartner.blurb': 'ACC: 142 aktive Mitglieder, 70+ Gruppentouren pro Jahr, 1.200+ gemeinsame Kilometer pro Monat. Wir sind die Radsportler in München, die wirklich rausfahren — meldet euch, wenn eure Marke diese Community erreichen soll.',
