...
export const ui = {
    zh: {
        ...
        'about.contactH2': '一起骑，路更远。',
        'about.contactLede': '刚搬到慕尼黑？从别的俱乐部过来？还是只想先来感受一下？给我们写封信 — 每一封都会认真回。',
        'about.contactEmail': 'hello@across-cc.de',
    ...
    en: {
        ...
        'about.sectionRuleJoin': 'Join Us',
        'about.contactEyebrow': 'Contact',
        'about.contactH2': 'Riding is better together.',
        'about.contactLede': "New to Munich? Visiting from another club? Or just curious about joining a ride? Drop us a line — we read everything.",
        'about.contactEmail': 'hello@across-cc.de',
    ...
    de: {
        ...
        'about.contactH2': 'Gemeinsam fährt es sich besser.',
        'about.contactLede': 'Neu in München? Zu Besuch aus einem anderen Club? Oder einfach neugierig auf eine Ausfahrt? Schreib uns — wir lesen jede Nachricht.',
        'about.contactEmail': 'hello@across-cc.de',
