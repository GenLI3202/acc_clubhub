...
export const ui = {
    zh: {
        ...
        'partners.becomePartner.blurb': 'ACC 现有 142 名活跃成员、年度 70+ 次团骑、每月 1,200+ 公里集体里程。如果你的品牌想以认真的方式接触慕尼黑的公路与山地骑行人群——欢迎联系我们。',
    ...
    en: {
        ...
        'partners.becomePartner.blurb': 'ACC has 142 active members, 70+ group rides a year, and 1,200+ collective kilometres a month. If your brand wants a serious way into Munich\'s road and mountain cycling community — we\'d love to talk.',
    ...
    de: {
        ...
        'partners.becomePartner.blurb': 'ACC: 142 aktive Mitglieder, 70+ Gruppentouren pro Jahr, 1.200+ gemeinsame Kilometer pro Monat. Wenn ihr eure Marke ernsthaft in die Münchner Road- & MTB-Szene bringen wollt — sprecht uns an.',
