...
export const ui = {
    zh: {
        ...
        'event.insuranceNoticeTitle': 'ACC官方骑行 · 保险告知',
        'event.insuranceNoticeFee': '非会员保险管理费：非学生 2€ | 学生 1€ | ACC会员免费',
        'event.insuranceLinkText': '查看保险及免责详情 →',
    ...
    en: {
        ...
        'event.insuranceNoticeTitle': 'ACC Official Ride · Insurance Notice',
        'event.insuranceNoticeFee': 'Non-member insurance fee: Non-student 2€ | Student 1€ | ACC member free',
        'event.insuranceLinkText': 'View insurance & liability details →',
    ...
    de: {
        ...
        'event.insuranceNoticeTitle': 'ACC Offizielle Ausfahrt · Versicherungshinweis',
        'event.insuranceNoticeFee': 'Versicherungsbeitrag für Nichtmitglieder: Nicht-Student 2€ | Student 1€ | ACC-Mitglied kostenlos',
        'event.insuranceLinkText': 'Versicherungs- und Haftungsdetails →',
